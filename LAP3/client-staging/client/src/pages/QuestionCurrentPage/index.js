...
const QuestionCurrentPage = () => {
  ...
  useEffect(() => setBtnIncorrectStyle("border mx-auto mt-5 w-96 h-16 px-4 py-1 rounded-full bg-purple-500 text-white"), [])
  ...
  const sendIncorrect = () => {
    ...
    setTimeout(() => {
      setBtnIncorrectStyle("border mx-auto mt-5 w-96 h-16 px-4 py-1 rounded-full bg-purple-500 text-white")
    }, 3000)
  }
